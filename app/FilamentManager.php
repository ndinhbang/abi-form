...
//use App\Models\Contracts\HasAvatar;
//use App\Models\Contracts\HasName;
use App\Navigation\UserMenuItem;
...
//    protected $globalSearchProvider = DefaultGlobalSearchProvider::class;
    ...
    {
        /** @var \App\Navigation\NavigationBuilder $builder */
    ...
    public function getUserMenuItems(): array
    {
        return collect($this->userMenuItems)
            ->sort(function (UserMenuItem $item): int {
                return $item->getSort();
            })
            ->toArray();
    }
